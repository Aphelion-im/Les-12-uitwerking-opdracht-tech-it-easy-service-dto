...
public class TelevisionController {
    ...
    public ResponseEntity<TelevisionDto> addTelevision(@Valid @RequestBody TelevisionInputDto televisionInputDto) { // In deze inputdto hoef je geen id op te geven.
    ...
    // Hier verandert niks aan de methode. We hebben niet meer de naam van de pathvariabele expliciet genoemd, omdat de
    // parameter-naam overeen komt met de naam van de pathvariabele.
    // Bedoelt hij met bovenstaande: @PathVariable(value="id")?
